...
public class UIButton extends UIComponent
{
	...
	/*
	private class UIDefaultButtonListener extends UIButtonListener
	{
	...
	*/
	...
	public void update()
	{
		...
		boolean leftMouseButtonDown = Mouese.getButton() ==MouseEvent.BUTTON1;
		if(rect.contains(new Point(Mouese.getX(),Mouese.getY())))
		{
			if(!inside)
			{	
			...
			else if(Mouese.getButton() == MouseEvent.NOBUTTON)
			{
				if(pressed)
				{					
